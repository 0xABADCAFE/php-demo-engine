...
$oChipMachine
    ...
    ->setVoiceWaveform(2, Audio\Signal\IWaveform::POKEY)
...
$oElectricGuitar
    ...
    // Output
    ->setOutputLevel(0.15)
    ->setInsert(new Audio\Signal\Insert\DelayLoop(null, 150*4, 0.3))
;
...
$oSequencer->allocatePattern('perc', [0])
    ->addEvent(Event::noteOn('B3', 80), Audio\Machine\TRNaN::KICK, 27)
    ->addEvent(Event::noteOn('B3', 100), Audio\Machine\TRNaN::KICK, 28)
    ->addEvent(Event::noteOn('A3', 100), Audio\Machine\TRNaN::SNARE, 28)
    ->addEvent(Event::noteOn('A3', 100), Audio\Machine\TRNaN::SNARE, 30)
    ->addEvent(Event::noteOn('A4', 75),  Audio\Machine\TRNaN::HH_OPEN, 27)
    ->addEvent(Event::noteOn('A4', 75),  Audio\Machine\TRNaN::HH_OPEN, 31)
;

$oSequencer->allocatePattern('perc', [1, 2])
    ->addEvent(Event::noteOn('B3', 100), Audio\Machine\TRNaN::KICK, 0, 4)
    ->addEvent(Event::noteOn('A3', 80), Audio\Machine\TRNaN::KICK, 9)
    ->addEvent(Event::noteOn('A3', 80), Audio\Machine\TRNaN::KICK, 27)
    ->addEvent(Event::noteOn('A3', 100), Audio\Machine\TRNaN::SNARE, 4, 8)
    ->addEvent(Event::noteOn('A3', 100), Audio\Machine\TRNaN::SNARE, 30)
    ->addEvent(Event::noteOn('A4', 55),  Audio\Machine\TRNaN::HH_CLOSED, 0, 2)
    ->addEvent(Event::noteOn('A4', 55),  Audio\Machine\TRNaN::HH_OPEN, 31)

    ->addEvent(Event::noteOn('C#4', 100), Audio\Machine\TRNaN::COWBELL, 11)
;
