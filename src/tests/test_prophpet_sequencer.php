...
$oSequencer->allocatePattern('perc', [3, 4, 5, 6, 7])
    ->addEvent(Event::noteOn('B3', 100), Audio\Machine\TRNaN::KICK, 0, 4)
...
$oSequencer->allocatePattern('bass', [0, 1, 2, 3, 4, 7])
...
$oSequencer->allocatePattern('bass', [5])
...
$oSequencer->allocatePattern('bass', [6])
