...
$oBassPattern->addEvent(new Audio\Sequence\NoteOn('C3'), 0, 64 + 1, 8);
$oBassPattern->addEvent(new Audio\Sequence\NoteOn('C2'), 0, 2, 8);
$oBassPattern->addEvent(new Audio\Sequence\NoteOn('C3'), 0, 64 + 3, 8);
$oBassPattern->addEvent(new Audio\Sequence\NoteOn('G1'), 0, 4, 8);
$oBassPattern->addEvent(new Audio\Sequence\NoteOn('G2'), 0, 64 + 5, 8);
$oBassPattern->addEvent(new Audio\Sequence\NoteOn('A#1'), 0, 6, 8);
$oBassPattern->addEvent(new Audio\Sequence\NoteOn('A#2'), 0, 64 + 7, 8);
...
$oDrumPattern->addEvent(new Audio\Sequence\NoteOn('C2'), 0, 32 + 29, 32);
$oDrumPattern->addEvent(new Audio\Sequence\NoteOn('C2'), 3, 2, 4);
$oDrumPattern->addEvent(new Audio\Sequence\NoteOn('C2'), 2, 64 + 1, 4);
$oDrumPattern->addEvent(new Audio\Sequence\NoteOn('C2'), 2, 64 + 3, 4);
$oDrumPattern->addEvent(new Audio\Sequence\NoteOn('C2'), 5, 32 + 4, 8);
$oDrumPattern->addEvent(new Audio\Sequence\NoteOn('C2'), 5, 32 + 31, 32);
$oDrumPattern->addEvent(new Audio\Sequence\NoteOn('C2'), 1, 60);
$oDrumPattern->addEvent(new Audio\Sequence\NoteOn('C2'), 1, 61);
$oDrumPattern->addEvent(new Audio\Sequence\NoteOn('C2'), 4, 63);


$oChipMachine = new Audio\Machine\ChipTune(4);
$oChipMachine->setInsert(new Audio\Signal\DelayLoop(null, 555, -0.75, 1.0, 0.3));
...
$oChipPattern->addEvent(new Audio\Sequence\NoteOn('Eb4'), 0, 128 + 0);
$oChipPattern->addEvent(new Audio\Sequence\NoteOn('E4'),  1, 128 +32);
$oChipPattern->addEvent(new Audio\Sequence\NoteOn('C3'),  2, 128 + 8);
$oChipPattern->addEvent(new Audio\Sequence\NoteOn('G3'),  3, 128 + 0);
...
$oSequencer->play($oPCMOut, 256, 4.0);
